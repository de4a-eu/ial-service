...
public final class IALVersion
{
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger (IALVersion.class);

  static
  {
    String sProjectVersion = null;
    String sProjectTimestamp = null;
    final ICommonsMap <String, String> p = PropertiesHelper.loadProperties (new ClassPathResource ("ial-version.properties",
                                                                                                   IALVersion.class.getClassLoader ()));
    if (p != null)
    {
